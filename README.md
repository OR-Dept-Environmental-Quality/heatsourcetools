...
df.hs7temp <- read.hs.outputs(output_dir = dir_hs7, file_name = "HS7.Jenny.Crk.xlsm", hs_ver = 7, sheet_name = "Output - Temperature")
df.hs6temp <- read.hs.outputs(output_dir = dir_hs6, file_name = "HS6.Jenny.Crk.xlsm", hs_ver = 6, sheet_name = "Long Temp Output")
